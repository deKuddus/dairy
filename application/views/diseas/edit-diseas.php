        ...
        <div class="row">
            <div class="col-md-12">
                <?php foreach ($diseases as  $value) {?>
                 <?php echo form_open_multipart('diseas/update/'.$value->id,'class="form-horizontal" id="addDiseas"'); ?>
                 <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update Disease Data</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input autocomplete="off" type="text" class="form-control" name="name" value="<?php echo $value->name ?>" required="true" />
                                </div>
                            </div>
                                ...
                                <select class="selectpicker" data-style="btn btn-success btn-block" data-size="4" name="type" required="true"> 
                                    ...
                                    <?php foreach ($types as  $type) {?>
                                        <option value="<?php echo $type->id ?>"
                                            <?php if($value->type == $type->id) echo "selected"; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input autocomplete="off" type="text" class="form-control" name="comment" value="<?php echo $value->comment ?>" />
                                </div>
                            </div>
                            <div class="col-sm-2 label-on-right">
                                <code></code>
