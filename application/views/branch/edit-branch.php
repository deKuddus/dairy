...
<div class="row">
    <div class="col-md-12">
        ...
        <?php echo form_open_multipart('branch/update/'.$value->id,'class="form-horizontal" id="addBranch"'); ?>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="text" class="form-control" name="address_line_1" value="<?php echo $value->address_line_1 ?>"  />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="text" class="form-control" name="address_line_2" value="<?php echo $value->address_line_2 ?>"  />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="number" class="form-control" id="contact" name="contact" value="<?php echo $value->contact ?>"/>
