...
<div class="row">
    <div class="col-md-12">
        ...
        <?php echo form_open_multipart('shed/update/'.$value->id,'class="form-horizontal" id="addBranch"'); ?>
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="text" class="form-control" name="name" required="true" value="<?php echo $value->name ?>" />
                            ...
                            <div class="form-group">
                                <select name="branch_id" id="" class="form-control" required="true">
                                    ...
                                    <option value="<?php echo $branch->id ?>" 
                                        <?php if($branch->id == $value->branch_id) echo "selected"; ?>
