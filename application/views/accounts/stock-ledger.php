      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a href="http://dairy.octoriz.com/oct-account/cash-payment" class="btn btn-default">Previous Page</a>
          </div>
    ...
    <div class="card card-body">
        ...
        <p class="mb-0">
            ...
            <a class="font-weight-bold" href="http://dairy.octoriz.com/oct-account">Accounts</a> >
                ...
                <a class="font-weight-bold"
                   href="http://dairy.octoriz.com/oct-account/6">Stocks</a>
                >
        ...
        <div class="card card-body">
            ...
            <h4 class="card-title mt-0">Stocks ledgers</h4>
            ...
            <ul class="mb-0">
                ...
                <form class="card card-body" action="http://dairy.octoriz.com/oct-account/6/product-ledger"
                      method="POST">

                    <input type="hidden" name="_token" value="hV8qlj5A4wm0Dpja53jz1nR77cZ0osvk5TxV1IU2">
                    <input type="hidden" name="oct_account_id" value="6">

                    <h4 class="card-title mt-0">Add Stocks ledger</h4>
