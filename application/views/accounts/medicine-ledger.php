      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a href="http://dairy.octoriz.com/oct-account/6" class="btn btn-default">Previous Page</a>
          </div>
...
<div class="printarea">
    ...
    <div class="card card-body">
        ...
        <p class="mb-0">
            ...
            <a class="font-weight-bold" href="http://dairy.octoriz.com/oct-account">Accounts</a> >
                ...
                <a class="font-weight-bold"
                   href="http://dairy.octoriz.com/oct-account/1">Assets</a>
                >

            
                <a class="font-weight-bold"
                   href="http://dairy.octoriz.com/oct-account/5">Current Assets</a>
                >

            
                <a class="font-weight-bold"
                   href="http://dairy.octoriz.com/oct-account/13">Medicines</a>
                >
        ...
        <div class="card card-body">
            ...
            <h4 class="card-title mt-0">Medicines ledgers</h4>
            ...
            <ul class="mb-0">
                ...
                <form class="card card-body" action="http://dairy.octoriz.com/oct-account/13/product-ledger"
                      method="POST">

                    <input type="hidden" name="_token" value="hV8qlj5A4wm0Dpja53jz1nR77cZ0osvk5TxV1IU2">
                    <input type="hidden" name="oct_account_id" value="13">

                    <h4 class="card-title mt-0">Add Medicines ledger</h4>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" min="0" value="0" name="current_quantity" required>
                    </div>

                    <div class="form-group">
                        <label for="">Unit Buy Price</label>
                        <input class="form-control" type="number" min="0" value="0" name="unit_buy_price">
                    </div>

                    <div class="form-group">
                        <label for="">Unit Sell Price</label>
                        <input class="form-control" type="number" min="0" value="0" name="unit_sell_price">
                    </div>
