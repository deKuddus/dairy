    ...
    <div class="card card-body">
        ...
        <p class="mb-0">
            ...
            <a class="font-weight-bold" href="http://dairy.octoriz.com/oct-account">Accounts</a> >
                ...
                <a class="font-weight-bold"
                   href="http://dairy.octoriz.com/oct-account/7">Customers</a>
                >
        ...
        <div class="card card-body">
            ...
            <h4 class="card-title mt-0">Customers ledgers</h4>
            ...
            <ul class="mb-0">
                ...
                <form class="card card-body" action="http://dairy.octoriz.com/oct-account/7/ledger" method="POST">

                    <input type="hidden" name="_token" value="hV8qlj5A4wm0Dpja53jz1nR77cZ0osvk5TxV1IU2">
                    <input type="hidden" name="oct_account_id" value="7">

                    <h4 class="card-title mt-0">Add Customers ledger</h4>
