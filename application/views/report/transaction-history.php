...
<div class="printarea">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <h4 class="card-title mt-0 mb-0">Transaction History</h4>
        </div>

        <hr class="mt-0">

        <form class="text-center" action="http://dairy.octoriz.com/oct-account/transaction-history/query" autocomplete="off">
                ...
                <table width="100%" class="text-center">
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-success" type="button" onclick="printNow('transactionHistory')">
                                Print
                            </button>
                        </td>
                    </tr>
    ...
    <div class="card card-body" id="transactionHistory">
        ...
        <table class="table table-bordered">
            <thead>
            <tr>
                <th class="border text-center" width="50%">
                    Title
                </th>
                <th class="border text-center" width="50%">
                    Amount
            ...
            <tr>
                <td>
                    <a href="#" data-type="purchase" class="oct-load-data text-body oct-underline">Purchase</a>
                </td>
                <td>
                    0 TK
                </td>
            ...
            <tr>
                <td>
                    <a href="#" data-type="sale" class="oct-load-data text-body oct-underline">Sale</a>
                </td>
                <td>
                    0 TK
                </td>
            ...
            <tr>
                <td>
                    <a href="#" data-type="cash_payment" class="oct-load-data text-body oct-underline">Cash Payment</a>
                </td>
                <td>
                    0 TK
                </td>
            ...
            <tr>
                <td>
                    <a href="#" data-type="cash_receive" class="oct-load-data text-body oct-underline">Cash Receive</a>
                </td>
                <td>
                    0 TK
                </td>
    ...
    <div class="text-right">
        <button class="btn btn-success" type="button" onclick="printNow('transactionHistoryDetails')">
            Print Details
        </button>
    </div>

    <div class="card card-body" id="transactionHistoryDetails">
        ...
        <table class="table table-bordered text-center mb-0">
            <thead>
            <tr>
                <th class="border" width="25%">Debit</th>
                <th class="border" width="25%">Credit</th>
                <th class="border" width="25%">Amount</th>
                <th class="border" width="25%">Date</th>
            </tr>
            </thead>
            <tbody id="items">
...
<script type="text/javascript">
    ...
    <script>
        ...
        $('a.oct-load-data').on('click', function () {
            ...
            $.ajax({
                    url: '/api/oct-account/transaction/' + type + '/20-09-2019/20-09-2019',
