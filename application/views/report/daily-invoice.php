      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a href="http://dairy.octoriz.com/oct-account/daily-invoice-report" class="btn btn-default">Previous Page</a>
          </div>
...
<div class="printarea">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <h4 class="card-title mt-0 mb-0">Daily Invoice Report</h4>
        </div>

        <hr class="mt-0">

        <div class="card-body">
            <form class="text-center" action="http://dairy.octoriz.com/oct-account/daily-invoice-report/single" autocomplete="off">

                <table width="100%">
                    <tr>
                        <td width="33.33%" class="text-sm-right pr-2">
                            <label class="big" for="invoice_id">Invoice Id</label>
                        </td>
                        <td width="33.33%">
                            <input class="form-control" placeholder="Invoice Id" type="text" id="invoice_id"
                                   name="invoice_id" pattern="[0-9]+" required>
                        </td>
                        <td width="33.33%" class="text-sm-left pl-2">
        ...
        <div class="card-body">
            <form class="text-center" action="http://dairy.octoriz.com/oct-account/daily-invoice-report/query" autocomplete="off">
                ...
                <table width="100%" class="text-center">
                    <tr>
                        ...
                        <td class="text-left">
                            <input class="form-control datepicker" pattern="\d{1,2}/\d{1,2}/\d{4}" id="date-picker"
                                   placeholder="Start Date" type="text" value="20/09/2019"
                        ...
                        <td class="text-left">
                            <input class="form-control datepicker" pattern="\d{1,2}/\d{1,2}/\d{4}" id="date-picker"
                                   placeholder="End Date" type="text" value="20/09/2019"
                        ...
                        <td>
                            <select class="custom-select" name="type">
                                <option value="" selected>Filter by type</option>
                                                                    ...
                                                                    <option value="3">EXPANSE</option>
                                                                    <option value="4">CASH PAYMENT</option>
                                                                    <option value="5">CASH RECEIVE</option>
                                                            </select>
                        </td>
                        <td>
    ...
    <div class="text-right">
        <button type="button" class="btn btn-success" onclick="printNow('invoiceReport')">Print Report</button>
    </div>

    <div class="card card-body" id="invoiceReport">
        <div class="text-center">
            <p style="font-size: 2em;margin-bottom: 0;font-weight: bold;">
                Daily Invoice Report
            </p>
            <p style="font-size: 1.2em">
                20/09/2019 to 20/09/2019
            </p>
        </div>
        ...
        <table class="table table-striped table-bordered text-center mb-0">
            ...
            <tr>
                ...
                <th class="border">Invoice Type</th>
            ...
            <tbody id="items">
                ...
                <tr>
                    <td>8</td>
                    <td>PURCHASE</td>
                    <td>Sina Ghas Ghor</td>
                    <td>19 Sep 2019</td>
                    <td>
                                                    <a href="http://dairy.octoriz.com/oct-account/invoice/8/print"
                               class="btn btn-sm btn-success">Print</a>
                                                <a href="http://dairy.octoriz.com/oct-account/invoice/8/edit"
                           class="btn btn-sm btn-primary">Edit</a>
                        <a style="color: white" class="btn btn-sm btn-danger" id="delete" data-token="hV8qlj5A4wm0Dpja53jz1nR77cZ0osvk5TxV1IU2"
                           data-id="8">Delete</a>
                    </td>
                </tr>
