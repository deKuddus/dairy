...
<div class="printarea">
    ...
    <div class="card card-body">
        ...
        <h4 class="card-title mt-0">New Sell</h4>
        ...
        <table width="100%" class="text-center">
            ...
            <tr>
                ...
                <td>
                    <input class="form-control" class="datepicker" type="text" name="date"
                ...
                <td>
                    <input class="form-control" type="text" id="customer_name" name="customer_name" autocomplete="off">
                </td>

                <td>
                    <div class="col-3">
                        <button class="btn btn-danger" id="btn-reset-customer">Reset</button>
                    </div>
                </td>
    ...
    <div class="card card-body">
        ...
        <h4 class="card-title mt-0">Add to cart</h4>
    ...
    <form action="http://dairy.octoriz.com/oct-account/sell" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <div class="card card-body">
                    ...
                    <button class="btn btn-success" type="submit">Save New Sell</button>
...
<script type="text/javascript">
    ...
    <script>
        ...
        // Search Customer
        $('input#customer_name').on('keyup change', function () {

            $('input#customer_name').autocomplete({
                source: "/api/oct-account/7/customer/ledger/" + $(this).val(),
                minLength: 1,
                select: function (event, ui) {
                    $('input#customer_id').val(ui.item.id);
        ...
        // Reset customer form
        $('button#btn-reset-customer').on('click', function (e) {
        ...
        $('input#product_name').on('keyup change', function () {
            ...
            $('input#product_name').autocomplete({
                source: "/api/oct-account/6/none/ledger/" + $(this).val(),
                minLength: 1,
                select: function (event, ui) {
                    ...
                    // $('td#present_stock').text('Present Stock: ' + ui.item.quantity + ' ' + ui.item.unit);
                    // $('td#show_unit_price').text('Unit price: ' + ui.item.unit_sell_price + ' TK');
                    //
                    // $('input#product_quantity').attr("max", ui.item.quantity);
            ...
            $.ajax(
                {
                    ...
                    success: function (quantity, textStatus, jqXHR) {
                        ...
                        $('input#product_quantity').attr("max", quantity);
        ...
        $('button#add_product').on('click', function (e) {
            ...
            $product_quantity_max = $('input#product_quantity').attr('max');
            $product_unit = $('input#product_unit').val();
            $product_sell_price = $('input#product_sell_price').val();
            $product_sell_price = $('input#product_buy_price').val();
            ...
            if (parseFloat($product_quantity) > parseFloat($product_quantity_max)) {
                swal({
                    title: 'Warning',
                    text: 'Product "' + $product_name + '" quantity does not match with stock!',
                    type: 'warning'
                });
                return;
            }

            let $total_amount = (parseFloat($product_sell_price) * parseFloat($product_quantity)).toFixed(2);
            ...
            $('tbody#items').append("<tr data-id='" + $product_id + "'>" +
                ...
                "<input id='inProductQuantity' class='inProductQuantity form-control' type='number' min='1' name='product_quantity[" + $product_id + "]' max='" + $product_quantity_max + "' value='" + $product_quantity + "' required>" +
                "</td>" +
                "<td class='border-left-0'>" + $product_unit + "</td>" +
                "<td>" +
                "<input id='inProductSellPrice' class='inProductSellPrice form-control' type='number' min='1' step='any' name='product_sell_price[" + $product_id + "]' value='" + $product_sell_price + "'>" +
                "</td>" +
        ...
        $('body').on('keyup change', 'input.inProductQuantity', function () {
            ...
            let $product_sell_price = $parent.find($('input#inProductSellPrice'));

            let $product_sell_price_val = parseFloat($product_sell_price.val()) || 0;

            let $final_amount = ($product_sell_price_val * $product_quantity_val).toFixed(2);
        ...
        $('body').on('keyup change', 'input.inProductSellPrice', function () {
            ...
            let $product_sell_price_val = parseFloat($(this).val()) || 0;

            let $product_quantity = $parent.find($('input#inProductQuantity'));

            let $product_quantity_val = parseFloat($product_quantity.val()) || 0;

            let $final_amount = ($product_quantity_val * $product_sell_price_val).toFixed(2);
