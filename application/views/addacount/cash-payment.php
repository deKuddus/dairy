...
<div class="printarea">
    ...
    <div class="card card-body">
        ...
        <h4 class="card-title mt-0">Cash Payment</h4>
    ...
    <form action="http://dairy.octoriz.com/oct-account/cash-payment" method="POST" autocomplete="off">
            ...
            <table width="100%" class="text-center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input class="form-control" type="text" id="expense_name" name="expense_name" required>
                    </td>

                    <td>
                        <button type="button" class="btn btn-sm btn-danger" id="btn-reset-expense">Reset</button>
                    </td>
