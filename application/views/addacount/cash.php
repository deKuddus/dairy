...
<div class="printarea">
    ...
    <div class="card card-body">
        ...
        <h4 class="card-title mt-0">Cash Receive</h4>
    ...
    <form action="http://dairy.octoriz.com/oct-account/cash-receive" method="POST" autocomplete="off">
        ...
        <div class="card card-body">
            ...
            <table width="100%" class="text-center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" id="income_id" name="income_id" required>
                        <input class="form-control" type="text" id="income_name" name="income_name" required>
                    </td>

                    <td>
                        <button type="button" class="btn btn-sm btn-danger" id="btn-reset-income">Reset</button>
                    </td>
                    ...
                    <td>
                        <input class="form-control" type="number" min="1" step="any"
                               id="amount" name="amount" required disabled>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <textarea class="form-control" type="text"
                                  id="comment" name="comment" disabled></textarea>
                    </td>
...
<script type="text/javascript">
    ...
    <script>
        ...
        // Search Expenses
        $('input#income_name').on('keyup change', function () {

            $('input#income_name').autocomplete({
                source: "/api/oct-account/0/none/ledger/" + $(this).val(),
                minLength: 1,
                select: function (event, ui) {
                    $('input#income_id').val(ui.item.id);
        ...
        // Reset amount fiels
        $('button#btn-reset-income').on('click', function (e) {

            $('input#income_id').val("");
            $('input#income_name').val("");
            $('input#income_name').prop('disabled', false);
